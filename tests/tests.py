...
def setUp(self):
    ...
    self.new_comment = Comment(comment = 'nice test',pitch = self.pitch_one,user = user_Elisephaamammamaa)
...
def test_check_instance_variables(self):
    ...
    self.assertEquals(self.pitch_one.user,self.user_Elisephan)
...
def test_instance_of_comment(self):
    ...
    self.assertEquals(self.new_comment.user,self.user_Elisephan)
